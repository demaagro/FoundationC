// src/lib.rs
/*
 * Core library for FoundationCSS
 */
...
#[derive(Debug)]
pub struct FoundationCSSProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FoundationCSSProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FoundationCSS processing");
    
    let mut processor = FoundationCSSProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FoundationCSSProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FoundationCSSProcessor::new(false);
